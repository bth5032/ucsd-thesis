...
\section{Motivations}
  ...
  \begin{figure}
    ...
    \end{center}
    \caption{
      \label{fig:feynman_ewk} \todo{same cap as AN}
  ...
  \subsection{Background Considerations} \label{sec:background_considerations}
    ...
    \subsubsection{MT2}
      ...
      \begin{figure}[h!]
        \centering
        \includegraphics[width=.5\textwidth]{figures/placeholder.png}
        \caption{\todo{To Be Updated with canonical MT2 decay.}}
    ...
    \subsubsection{MT2b}
      ...
      \begin{figure}[h!]
        \centering
        \includegraphics[width=.5\textwidth]{figures/placeholder.png}
        \caption{\todo{To be updated with TTBar Feynman diagram.}}
